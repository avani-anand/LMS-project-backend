...
.put(updateCourse) .delete(removeCourse);;    // ye methods id vale route  p isliye bnae kyuki update and remove krte time hume pta hona  chahiye ki konsi course m upadate kr rhe h
